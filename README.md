...
| Cluster | Categories |
|---|---|
| Core Protocol Infrastructure | AI & Agents, Blockchain Infrastructure, Developer Tools, Smart Contracts, Restaking, Cross-chain |
| Identity, Access & Compliance | Identity & Credentials, Privacy & ZK, Enterprise & Compliance, Healthcare |
| Finance, DeFi & Risk | Payments & DeFi, Marketplaces, Finance & Risk, Real-World Assets |
| Data, AI & Emerging Tech | Data & Oracles, Experimental & Emerging, AI Safety, Space & Deep Tech |
| Enterprise & Real World | SaaS & Platforms, Governance, Energy & IoT, DePIN, Supply Chain |
| Consumer & Community | Social, Gaming, Media, Education, Lifestyle, Consumer Web3 |
...
One of the most important structural patterns in the taxonomy is the identity-to-policy chain:

```
Identity → Auth → AuthZ → Access → Permission → Policy
```

- **Identity** — Who you are (`federal-id.eth`, `national-id.eth`, `stateid.eth`)
- **Auth** — Prove it (`authsystem.eth`, `authgateway.eth`)
- **AuthZ** — What you can do (`authzengine.eth`, `permissionregistry.eth`)
- **Access** — Open the door (`accessorchestrator.eth`, `accessgateway.eth`)
- **Permission** — Rules applied (`permissionledger.eth`, `policyengine.eth`)
- **Policy** — Governance layer (`compliancepolicy.eth`, `auditengine.eth`)

---

## ENS Pricing Guide

The **[ENS Pricing Guide](https://www.ensv2marketplace.com/pricing-guide.html)** is a complete 15-tier scoring framework for valuing any ENS domain.
...
| 5 | Could someone replace this name and lose nothing? | Do not overprice | Price irreplaceability |
...
ENSv2 deploys exclusively on **Ethereum Layer 1** — Namechain (L2) was canceled February 2026.
...
*ENSv2 Marketplace™ — Real World Utility. Infrastructure over speculation.*  
*First published ontology and taxonomy for the ENS namespace.*
